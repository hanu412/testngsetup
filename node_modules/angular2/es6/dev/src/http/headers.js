...
import { isListLikeIterable, MapWrapper, ListWrapper } from 'angular2/src/facade/collection';
/**
...
export class Headers {
    ...
    has(header) { return MapWrapper.contains(this._headersMap, header); }
    ...
    set(header, value) {
        ...
        if (!isListLikeIterable(value)) {
            ...
            ListWrapper.push(list, ListWrapper.toString(value));
        }
